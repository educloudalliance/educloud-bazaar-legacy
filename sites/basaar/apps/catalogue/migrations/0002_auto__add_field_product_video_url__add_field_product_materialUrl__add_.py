...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalogue_product', 'materialUrl',
                      self.gf('django.db.models.fields.URLField')(default=datetime.datetime(2014, 7, 10, 0, 0), max_length=200),
                      keep_default=False)
    ...
    models = {
        ...
        u'catalogue.product': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'iconUrl': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_discountable': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'materialUrl': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'moreInfoUrl': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
