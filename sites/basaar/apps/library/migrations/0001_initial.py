...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductLibrary'
        db.create_table(u'library_productlibrary', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Product'])),
            ('dateOfPurchase', self.gf('django.db.models.fields.DateTimeField')()),
            ('basket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['basket.Basket'])),
            ('validated', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'library', ['ProductLibrary'])


    def backwards(self, orm):
        # Deleting model 'ProductLibrary'
        db.delete_table(u'library_productlibrary')
    ...
    models = {
        ...
        u'library.productlibrary': {
            'Meta': {'object_name': 'ProductLibrary'},
            'basket': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['basket.Basket']"}),
            'dateOfPurchase': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalogue.Product']"}),
            'validated': ('django.db.models.fields.BooleanField', [], {})
        },
        u'offer.benefit': {
