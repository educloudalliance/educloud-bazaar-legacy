...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductPurchased.quantity'
        db.add_column(u'library_productpurchased', 'quantity',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductPurchased.quantity'
        db.delete_column(u'library_productpurchased', 'quantity')
    ...
    models = {
        ...
        u'basket.basket': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'baskets'", 'null': 'True', 'to': u"orm['user.User']"}),
        ...
        u'library.productpurchased': {
            'Meta': {'object_name': 'ProductPurchased'},
            'basket': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['basket.Basket']"}),
            'dateOfPurchase': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'user.user': {
            ...
            'mepinId': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'oid': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
