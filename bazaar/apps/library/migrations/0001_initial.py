...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductPurchased'
        db.create_table(u'library_productpurchased', (
            ...
            ('dateOfPurchase', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal(u'library', ['ProductPurchased'])


    def backwards(self, orm):
        # Deleting model 'ProductPurchased'
        db.delete_table(u'library_productpurchased')
